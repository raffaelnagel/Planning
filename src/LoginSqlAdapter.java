...
public class LoginSqlAdapter {
	...
	public Login SelectLogin(DatabaseConnection mConnection, People mPeople){
	...
	public boolean InsertLogin(DatabaseConnection mConnection, Login mLogin, People mPeople){
		if(mConnection.isConnected()){			
			try {
